...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@ghurki-cricket/ui/components/sheet";
import { Tooltip, TooltipContent, TooltipTrigger } from "@ghurki-cricket/ui/components/tooltip";
		...
		props: mergeProps<"button">(
			{
				className: cn(
					...
					"data-active:bg-sidebar-accent data-active:text-sidebar-accent-foreground data-active:hover:bg-sidebar-accent",
					"data-open:hover:bg-sidebar-accent/50 data-open:hover:text-sidebar-accent-foreground",
					className,
				),
			},
			props,
