...
export function SheetHeader({ title, className, children, ...props }: React.ComponentProps<"div"> & { title: string }) {
	return (
		<div data-slot="sheet-header" className={cn("flex items-center justify-between border-b p-4", className)} {...props}>
			{children}
